    ...
    Scaffold(
        ...
        Column(modifier = Modifier.fillMaxSize().padding(innerPadding)) {
            ...
            CategoryGrid(
                ...
                emptyMessage = if (query.isBlank()) androidx.compose.ui.res.stringResource(com.izplay.v3.R.string.empty_category_no_movies) else androidx.compose.ui.res.stringResource(com.izplay.v3.R.string.empty_category_search_no_movies),
                itemKey = { it.id },
            ) { row ->
                PosterCard(
